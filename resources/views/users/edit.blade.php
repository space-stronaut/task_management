        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/members/update/{{$user->id}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" autocomplete="off" value="{{$user->email}}" class="form-control" required placeholder="Email" value="{{ old('email') }}">
                            </div>

                            <div class="form-group">
                                <label for="title">Password</label>
                                <input type="password" name="password" autocomplete="off" value="{{$user->password}}" class="form-control" required placeholder="Title" value="{{ old('title') }}">
                            </div>

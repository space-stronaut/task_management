                    ...
                    <form action="/tasks/update/{{$task->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="task_name" value="{{$task->task_name}}" class="form-control" required placeholder="Title">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="due_date" value="{{$task->due_date}}" class="form-control" required placeholder="Due Date" value="{{ old('title') }}">
                            </div>
